                  ...
                  <div className="w-full lg:w-6/12 px-4 lg:order-2">
                    <div className=" text-center">
                      ...
                      <div className="text-left">
                        ...
                        <div className="mb-2 text-blueGray-600">
                          Minted Token ID: {desc}
                        </div>
                        <div className="text-xl font-bold mb-2 text-blueGray-600">
                          The NFT has been added to your OpenSeas account associated with your MetaMask ID.
                        </div>
                      </div>
                    </div>
                  </div>
